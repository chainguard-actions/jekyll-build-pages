...
Hardened by [Chainguard](https://www.chainguard.dev) from the upstream action at [https://github.com/actions/jekyll-build-pages](https://github.com/actions/jekyll-build-pages).
